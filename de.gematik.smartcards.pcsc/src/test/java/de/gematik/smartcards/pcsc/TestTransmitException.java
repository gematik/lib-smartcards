...
final class TestTransmitException { // NM_CLASS_NOT_EXCEPTION
  ...
  /** Test method for {@link TransmitException#TransmitException(CardException)}. */
  @Test
  void test_TransmitException__PcscException() {
    // Assertions:
    // - none -
    ...
    // Test strategy:
    // --- a. smoke test
    final CardException cause = new CardException("foo");

    final TransmitException dut = new TransmitException(cause);
