...
project.version = "0.8.6" // for history of releases see CHANGELOG.md

group = "de.gematik.smartcards"

val libraryDescription = "Utility library"
...
tasks.withType<GenerateMavenPom>().configureEach {
  doFirst {
    ...
    pom.name.set("TKK's utility functions")
...
dependencies {
  ...
  testImplementation(libs.bcprov.jdk18on) // additional hash-algorithms
...
tasks.withType(Test::class) {
  ...
  // de.gematik.smartcards.utils:puToMaLo".

  // no statement about parallel test execution                      arthur => 33" .. 37"
  // maxParallelForks = 4                                         // arthur => 21" .. 23"
  // maxParallelForks = 8                                         // arthur => 24" .. 27"
  // maxParallelForks = 16                                        // arthur => 19" .. 32"
  val noProcessors = Runtime.getRuntime().availableProcessors()
  maxParallelForks = (noProcessors - 1).takeIf { it > 0 } ?: 1 // arthur => 22" .. 23"
