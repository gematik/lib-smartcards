...
/**
 * Class representing a TLV object of universal class with tag-number 5, i.e. Null-type.
 *
 * <p>For more information about the encoding, see <a
 * href="https://www.itu.int/rec/T-REC-X.690-202102-I/en">ISO/IEC 8825-1:2021</a> clause 8.8.
 *
 * <p>Because this type of TLV-object is always primitive, with tag-number 5 and the value-field is
 ...
 */
public final class DerNull extends PrimitiveSpecific<String> {

  /** Because this class has no values, the comment is fixed. */
  private static final String COMMENT = DELIMITER + "NULL"; // */

  /**
   * Integer representation of tag for Null.
   *
   ...
   */
  private DerNull() {
    // see ISO/IEC 8825-1:2025 clause 8.8.2
   ...
   */
  private DerNull(final ByteBuffer buffer) {
   ...
   */
  private DerNull(final InputStream inputStream) throws IOException {
   ...
   */
  private static DerNull checkInstance(final DerNull result) {
   ...
   */
  /* package */
  static DerNull readInstance(final ByteBuffer buffer) {
    return checkInstance(new DerNull(buffer));
  } // end method */
   ...
   */
  /* package */
  static DerNull readInstance(final InputStream inputStream) throws IOException {
    return checkInstance(new DerNull(inputStream));
  } // end method */
