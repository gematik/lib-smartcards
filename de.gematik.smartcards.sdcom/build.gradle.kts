...
project.version = "0.5.6" // for history of releases see CHANGELOG.md

group = "de.gematik.smartcards"

val libraryDescription = "security device communication"
...
tasks.withType<GenerateMavenPom>().configureEach {
  doFirst {
    ...
    pom.name.set("security device communication")
...
tasks.withType(Test::class) {
  ...
  // de.gematik.smartcards.sdcom:puToMaLo".

  // no statement about parallel test execution                      arthur => 22" ... 26"
  // maxParallelForks = 4                                         // arthur => 21" ... 22"
  val noProcessors = Runtime.getRuntime().availableProcessors()
  maxParallelForks = (noProcessors - 1).takeIf { it > 0 } ?: 1 // arthur => 27" ... 27"
}
